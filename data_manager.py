...
def createDebugDatabase():
    ...
    connection.addQuestion(questions_file_name, {'id': 1, 'submission_time': '1543395761.9055753', 'view_number': 5, 'vote_number': 25, 'title': 'Wut', 'message': 'FeelsGoodMan', 'image': 'https://cdn.betterttv.net/emote/56c2cff2d9ec6bf744247bf1/2x' })
